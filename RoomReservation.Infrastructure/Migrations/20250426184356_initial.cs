    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomsEquipments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoomsEquipments_Equipments_EquipmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomsReservationLimits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoomsReservationLimits_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomsEquipments_RoomId",
                table: "RoomsEquipments",
                column: "RoomId");

            migrationBuilder.CreateIndex(
                name: "IX_RoomsReservationLimits_RoomId",
